...
import { commentsApi } from '../../../redux/services/CommentsService';
import styles from './Reviews.module.scss';

const Reviwes = () => {
  const { data: dataComment, isLoading } = commentsApi.useFetchAllCommentsQuery('');
      ...
      <div className={styles.reviews__main}>
        <div className={styles.reviews__left}>
          ...
          {isLoading ? (
            ...
            <>
              {dataComment?.comments.map((comment) => (
                <div key={comment.id} className={styles.reviews__item}>
                  <div className={styles.reviews__head}>
                    <div className={styles.reviews__name}>{comment.user.username}</div>
                  ...
                  <div className={styles.reviews__body}>
                    <div className={styles.reviews__text}>{comment.body}</div>
                  </div>
        ...
        <div className={styles.reviews__right}>
          <div className={styles.reviews__information}>
            <div className={styles.reviews__count}>{dataComment?.comments.length} отзыва</div>
